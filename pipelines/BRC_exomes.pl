...
EASIH::Pipeline::add_step('bam_merge_realigned', 'bam_index_realigned', 'bam_index');
EASIH::Pipeline::add_step('bam_index_realigned', 'mark_dups');
EASIH::Pipeline::add_step('mark_dups', 'count_covariates');
